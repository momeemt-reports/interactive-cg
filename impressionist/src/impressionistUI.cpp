...
Fl_Menu_Item ImpressionistUI::menuitems[] = {
    ...
    {"&Copy Original Image to Canvas", FL_CTRL + 'v',
...
Fl_Menu_Item ImpressionistUI::brushTypeMenu[NUM_BRUSH_TYPE + 1] = {
    ...
    {"ScatteredCircles", FL_ALT + 'o',
     (Fl_Callback *)ImpressionistUI::cb_brushChoice,
     (void *)BRUSH_SCATTERED_CIRCLES},
    {"VividPoints", FL_ALT + 'v',
     (Fl_Callback *)ImpressionistUI::cb_brushChoice,
     (void *)BRUSH_VIVID_POINTS},
    {"VividScatteredLines", FL_ALT + 'w',
     (Fl_Callback *)ImpressionistUI::cb_brushChoice,
     (void *)BRUSH_VIVID_SCATTERED_LINES},
    // �u���V�ǉ�
    {0}};
...
void ImpressionistUI::applyFilter(void) {
  m_pDoc->applyFilter(m_pDoc->m_ucPreviewBackup, m_pDoc->m_nPaintWidth,
                      m_pDoc->m_nPaintHeight, m_pDoc->m_ucPainting, fltKernel,
                      FLT_WIDTH, FLT_HEIGHT, scale, offset);
  fltDesignUI->hide();
  m_paintView->refresh();
}
