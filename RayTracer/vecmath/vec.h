...
public:
  ...
  //---[ Friend Methods ]----------------------
  /* not implemented
          template <class U> friend T operator *( const Vec3<T>& a, const
     Vec4<T>& b ); template <class U> friend T operator *( const Vec4<T>& b,
     const Vec3<T>& a ); template <class U> friend Vec3<T> operator -( const
     Vec3<T>& v ); template <class U> friend Vec3<T> operator *( const Vec3<T>&
     a, const double d ); template <class U> friend Vec3<T> operator *( const
     double d, const Vec3<T>& a ); template <class U> friend Vec3<T> operator *(
     const Vec3<T>& v, Mat4<T>& a ); template <class U> friend T operator *(
     const Vec3<T>& a, const Vec3<T>& b ); template <class U> friend Vec3<T>
     operator *( const Mat3<T>& a, const Vec3<T>& v ); template <class U> friend
     Vec3<T> operator *( const Vec3<T>& v, const Mat3<T>& a ); template <class
     U> friend Vec3<T> operator *( const Mat4<T>& a, const Vec3<T>& v );
          template <class U> friend Vec3<T> operator /( const Vec3<T>& a, const
     double d ); template <class U> friend Vec3<T> operator ^( const Vec3<T>& a,
     const Vec3<T>& b ); template <class U> friend bool operator ==( const
     Vec3<T>& a, const Vec3<T>& b ); template <class U> friend bool operator !=(
     const Vec3<T>& a, const Vec3<T>& b ); template <class U> friend ostream&
     operator <<( ostream& os, const Vec3<T>& v ); template <class U> friend
     istream& operator >>( istream& is, Vec3<T>& v ); template <class U> friend
     Vec3<T> minimum( const Vec3<T>& a, const Vec3<T>& b ); template <class U>
     friend Vec3<T> maximum( const Vec3<T>& a, const Vec3<T>& b ); template
     <class U> friend Vec3<T> prod( const Vec3<T>& a, const Vec3<T>& b );
          */
};
...
public:
  ...
  //	template <class U> friend Vec4<T> operator *( const Vec4<T>& v, const
  // Mat4<T>& a );
  template <class U> friend Vec4<T> operator/(const Vec4<T> &a, const double d);
  //	template <class U> friend Vec4<T> operator ^( const Vec4<T>& a, const
  // Vec4<T>& b );
...
template <class T> void Vec<T>::zeroElements() {
  memset(n, 0, numElements * sizeof(T));
}
...
inline Vec3<T> operator*(const Mat4<T> &a, const Vec3<T> &v) {
  return Vec3<T>(a.n[0] * v.n[0] + a.n[1] * v.n[1] + a.n[2] * v.n[2] + a.n[3],
                 ...
                 a.n[8] * v.n[0] + a.n[9] * v.n[1] + a.n[10] * v.n[2] +
                     a.n[11]);
}
...
inline Vec4<T> operator*(const Mat4<T> &a, const Vec4<T> &v) {
  return Vec4<T>(
      ...
      a.n[12] * v.n[0] + a.n[13] * v.n[1] + a.n[14] * v.n[2] +
          a.n[15] * v.n[3]);
}
...
template <class T> inline Vec4<T> prod(const Vec4<T> &a, const Vec4<T> &b) {
  return Vec4<T>(a.n[0] * b.n[0], a.n[1] * b.n[1], a.n[2] * b.n[2],
                 a.n[3] * b.n[3]);
}
