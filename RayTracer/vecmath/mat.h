...
public:
  ...
  Mat4(T n0, T n1, T n2, T n3, T n4, T n5, T n6, T n7, T n8, T n9, T n10, T n11,
  ...
  Mat4(const Vec4<T> &v0, const Vec4<T> &v1, const Vec4<T> &v2,
       const Vec4<T> &v3) {
    n[0] = v0[0];
    n[1] = v0[1];
    n[2] = v0[2];
  ...
  Mat4<T> transpose() const {
    return Mat4<T>(n[0], n[4], n[8], n[12], n[1], n[5], n[9], n[13], n[2], n[6],
                   n[10], n[14], n[3], n[7], n[11], n[15]);
  }
...
template <class T> inline Mat3<T> operator-(const Mat3<T> &a) {
  return Mat3<T>(-a.n[0], -a.n[1], -a.n[2], -a.n[3], -a.n[4], -a.n[5], -a.n[6],
                 -a.n[7], -a.n[8]);
}
...
template <class T> inline Mat3<T> operator*(const Mat3<T> &a, const double d) {
  return Mat3<T>(a.n[0] * d, a.n[1] * d, a.n[2] * d, a.n[3] * d, a.n[4] * d,
...
inline Mat4<T> Mat4<T>::createRotation(T angle, float x, float y, float z) {
  ...
  Vec3<T> a(x, y, z);
  a.normalize();
  return Mat4<T>(t * a[0] * a[0] + c, t * a[0] * a[1] - s * a[2],
...
template <class T> inline Mat4<T> operator-(const Mat4<T> &a) {
  return Mat4<T>(-a.n[0], -a.n[1], -a.n[2], -a.n[3], -a.n[4], -a.n[5], -a.n[6],
                 -a.n[7], -a.n[8], -a.n[9], -a.n[10], -a.n[11], -a.n[12],
                 -a.n[13], -a.n[14], -a.n[15]);
}

template <class T>
inline Mat4<T> operator+(const Mat4<T> &a, const Mat4<T> &b) {
  return Mat4<T>(a.n[0] + b.n[0], a.n[1] + b.n[1], a.n[2] + b.n[2],
                 a.n[3] + b.n[3], a.n[4] + b.n[4], a.n[5] + b.n[5],
                 a.n[6] + b.n[6], a.n[7] + b.n[7], a.n[8] + b.n[8],
                 a.n[9] + b.n[9], a.n[10] + b.n[10], a.n[11] + b.n[11],
                 a.n[12] + b.n[12], a.n[13] + b.n[13], a.n[14] + b.n[14],
                 a.n[15] + b.n[15]);
}
...
inline Mat4<T> operator*(const Mat4<T> &a, const Mat4<T> &b) {
  return Mat4<T>(
      a.n[0] * b.n[0] + a.n[1] * b.n[4] + a.n[2] * b.n[8] + a.n[3] * b.n[12],
      ...
      a.n[12] * b.n[0] + a.n[13] * b.n[4] + a.n[14] * b.n[8] +
          a.n[15] * b.n[12],
      a.n[12] * b.n[1] + a.n[13] * b.n[5] + a.n[14] * b.n[9] +
          a.n[15] * b.n[13],
      a.n[12] * b.n[2] + a.n[13] * b.n[6] + a.n[14] * b.n[10] +
          a.n[15] * b.n[14],
      a.n[12] * b.n[3] + a.n[13] * b.n[7] + a.n[14] * b.n[11] +
          a.n[15] * b.n[15]);
}

template <class T> inline Mat4<T> operator*(const Mat4<T> &a, const double d) {
  return Mat4<T>(a.n[0] * d, a.n[1] * d, a.n[2] * d, a.n[3] * d, a.n[4] * d,
                 a.n[5] * d, a.n[6] * d, a.n[7] * d, a.n[8] * d, a.n[9] * d,
                 a.n[10] * d, a.n[11] * d, a.n[12] * d, a.n[13] * d,
                 a.n[14] * d, a.n[15] * d);
}
...
template <class T> inline void makeHScale(Mat4<T> &m, const Vec3<T> &v) {
...
template <class T> inline void makeHTrans(Mat4<T> &m, const Vec3<T> &v) {
...
template <class T> inline void makeHRot(Mat4<T> &m, T theta, T x, T y, T z) {
